...
public class StringCalculator {
  public int add(String str) throws StringCalculatorException{
    // Returns the sum of the numbers given in numbersStr
    if (str.equals(""))
      return 0;
    int commaIndex = -1;
    for (int i = 0; i < str.length(); i++) {
      if (str.charAt(i) == '-' || !( (str.charAt(i)>=48 && str.charAt(i)<= 57) || str.charAt(i)==',')){
  ...
  public int addUnknown (String str) throws StringCalculatorException{
